import csv, os, statistics, warnings
import pandas as pd
import numpy as np
...
def process(subject_name, band):
    ...
    for col in df.columns:
        if col not in ['AF4:ALPHA/BETA_H', 'AF3:ALPHA/BETA_H', 'F7:ALPHA/BETA_H', 'P7:ALPHA/BETA_H', 'FC5:ALPHA/BETA_H',
                        'O2:ALPHA/BETA_H', 'P8:ALPHA/BETA_H', 'F3:ALPHA/BETA_H', 'AF4:ALPHA/BETA_L', 'T7:ALPHA/BETA_H',
                        'O1:ALPHA/BETA_H', 'AF3:ALPHA/BETA_L', 'P7:ALPHA/BETA_L', 'T8:ALPHA/BETA_H', 'F3:ALPHA/BETA_L',
                        'F4:ALPHA/BETA_H', 'F8:ALPHA/BETA_H', 'F7:ALPHA/BETA_L', 'FC5:ALPHA/BETA_L', 'P8:ALPHA/BETA_L',
                        'O2:ALPHA/BETA_L', 'F4:ALPHA/BETA_L', 'FC6:ALPHA/BETA_H', 'AF3:THETA/ALPHA', 'O1:ALPHA/BETA_L',
                        'F8:ALPHA/BETA_L', 'P7:THETA/ALPHA', 'T7:THETA/ALPHA', 'T8:ALPHA/BETA_L', 'AF4:THETA/ALPHA',
                        'STATE']:
            del df[col]
...
if __name__ == "__main__":
    ...
    # process('Combined.csv', ["AF3", "F7", "F3", "FC5", "T7", "P7", "O1", "O2", "P8", "T8", "FC6", "F4", "F8", "AF4"])
